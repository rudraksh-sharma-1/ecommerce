...
import { getAllProducts, getProductsByCategoryName, getProductsBySubcategoryName, getProductsByGroupName } from "../../utils/supabaseApi";
      ...
      <section className="py-3 pb-0 bg-gray-50 product-section">
        <div className="w-full px-4">
          <Breadcrumbs aria-label="breadcrumb" className="text-sm flex-wrap">
            ...
            {category && (!subcategory && !group) ? null : category && (
              <Link
                underline="hover"
                color="inherit"
                href={`/productListing?category=${encodeURIComponent(category)}`}
                className="text-gray-600 hover:text-blue-600 transition-colors"
              >
            ...
            {subcategory && (!group) ? null : subcategory && (
              <Link
                underline="hover"
                color="inherit"
                href={`/productListing?subcategory=${encodeURIComponent(subcategory)}&category=${encodeURIComponent(category)}`}
                className="text-gray-600 hover:text-blue-600 transition-colors"
              >
                <span className="text-xs sm:text-sm">
